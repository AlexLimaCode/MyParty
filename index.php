...
<body style="background-color: #1B1438;">
    <nav class="navbar navbar-expand-sm navbar-light sticky-top nav-text" style="background-color: #1B1438; border: 1px solid #eb3766;">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="nav-item">
                    <a class="nav-link text-center" style="color: #EB3766;" href="./pag/aboutUs.html">MyParty</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-center" style="color: #FF6B4D;" href="./pag/servicios.php">Servicios</a>
                </li>
                <li class="nav-item">
    ...
    <div class="portada">
        <?php
            ...
            if(isMobileDevice()){
                echo '<img class="img-fluid"  src="./img/celular.png" alt="">';
            }
            else {
                echo '<img class="img-fluid"  src="./img/portada1.png" alt="">';
            }
        ?>
    </div>
    <!-- Servicios -->
    ...
    <!-- Instagram section, esta seccion se tendra que automatizar con la nueva funcion en el banner para subir post -->
