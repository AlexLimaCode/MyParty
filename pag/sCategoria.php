...
<body >
    ...
    <div class="container">
    <div class="mb-3">
            <form method='post' enctype='multipart/form-data' action='./subirNegocio.php?padre=3' name='principal'>
            <div class="col-md-4">
                <label for="validationDefault02" class="form-label" style="color:white;">Selecciona el tipo de servicio</label>
                <?php
            ...
            <div class="col-md-4">
                ...
                <br>
              <button class='btn btn-primary' type='submit' href='./subirNegocio.php?padre=3'>Registrar</button>
          </form>
        </div>
    </div>
    <br><br>
