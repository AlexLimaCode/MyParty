                ...
                <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
                    ...
                    <table class="w-full">
                        ...
                        <tbody class="bg-white">
                            <?php
                                //PRIMER COLUMNA
                                $query = "select IdNegocio, nombre, s.Descripcion, c.Descripcion, n.IdServicio, n.IdEstatus, fecha, Whatsapp, Correo, Nombre from tblnegocios n, tblservicios s, 
                                tblcategorias c where n.IdServicio = s.IdServicio and n.IdCategoria = c.IdCategoria order by s.Descripcion asc, c.Descripcion asc";
                                $result = mysqli_query($conn, $query);
                                while ($row = mysqli_fetch_row($result)){
